...
<iframe width="760px" height="500px" src="https://sway.office.com/s/RUtZgIOpvrVODKJM/embed" frameborder="0" marginheight="0" marginwidth="0" max-width="100%" sandbox="allow-forms allow-modals allow-orientation-lock allow-popups allow-same-origin allow-scripts" scrolling="no" style="border: none; max-width: 100%; max-height: 100vh" allowfullscreen mozallowfullscreen msallowfullscreen webkitallowfullscreen></iframe>
...
4.	 Link Testing-	 Links worked	As Expected	 Pass
 ...
 9.	 Payment Gateways	 Payment Gateway worked	As Expected	 Pass  10.	 
